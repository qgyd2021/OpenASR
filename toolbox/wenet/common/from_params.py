...
def takes_arg(obj, arg: str) -> bool:
    ...
    if inspect.isclass(obj):
        ...
        raise ConfigurationError('object {} is not callable'.format(obj))
...
def takes_kwargs(obj) -> bool:
    ...
    result = bool(any([p.kind == inspect.Parameter.VAR_KEYWORD
...
class FromParams(object):
    ...
    def from_params(cls: Type[T], params: Params, **extras) -> T:
        ...
        logger.info('instantiating class {} from params {} '
                    'and extras {}'.format(cls, getattr(params, 'params', params), set(extras.keys())))
