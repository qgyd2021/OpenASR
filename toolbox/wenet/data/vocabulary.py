...
from toolbox.wenet.common.testing.checks import ConfigurationError
...
class Vocabulary(Registrable):
    ...
    def from_params(cls, params: Params, **extras):
        ...
        if not vocabulary_directory:
            raise ConfigurationError("You must provide a Params object containing a "
                                     "vocab_directory key to build a vocabulary from.")

        logger.info("Loading Vocab from files.")
